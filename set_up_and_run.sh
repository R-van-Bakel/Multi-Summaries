...
g++ -std=c++20 -Wall -Wpedantic -Ofast -fdiagnostics-color=always -I $BOOST_HOME/include/ ./code/full_bisimulation_from_binary.cpp -o ./bin/full_bisimulation_from_binary  $BOOST_HOME/lib/libboost_program_options.a
g++ -std=c++20 -Wall -Wpedantic -Ofast -fdiagnostics-color=always -I $BOOST_HOME/include/  ./code/condensed_post_hoc_metric_writer.cpp -o ./bin/condensed_post_hoc_metric_writer $BOOST_HOME/lib/libboost_program_options.a
